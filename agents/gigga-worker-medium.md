---
description: GIGGA worker (medium tier) — general-purpose executor; does one assigned task and reports changed files
mode: subagent
model: anthropic/claude-sonnet-4-5   # <!-- set by gigga-config -->
---
